...
# Save the plots
ggsave("../figures/male_single_column.png", male_plot, width = 8, height = 12)
ggsave("../figures/female_single_column.png", female_plot, width = 8, height = 12)
...
ggsave("../figures/combined_sexes_single_column.png", combined_sexes, width = 16, height = 12)
```
...
ggsave("../figures/normative_bysex.png")
```
...
ggsave("../figures/normative_mrsi_bysex.png")
```
...
ggsave("../figures/normative_RNPI_bysex.png")
```
...
ggsave("../figures/normative_rp_Force_bysex.png")
```
...
ggsave("../figures/normative_peak_bForce_bysex.png")
```
